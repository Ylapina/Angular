...
@Component({
  selector: 'app-prli-lines',
  templateUrl: './prli-lines.component.html',
  styleUrls: ['./prli-lines.component.css']
})
export class PrliLinesComponent implements OnInit {
    ...
    this.route.params.subscribe(params => {
      ...
      if (params.pr && params.prli) {
        this.prliSvc.delete(params.prli).subscribe(jr => {
          this.router.navigateByUrl('/prli/lines/' + params.pr);
        });
      }
    });
  }
